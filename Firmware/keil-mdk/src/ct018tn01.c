...
/* Default gamma tables derived from common ST77xx values; these are safe
 * working defaults. They can be overridden with ct018_set_gamma().
 */
static const uint8_t default_gamma_pos[] = {
    0x00,0x03,0x09,0x08,0x16,0x0A,0x03,0x0A,0x07,0x0B,0x0A,0x03,0x05,0x07,0x00
};
static const uint8_t default_gamma_neg[] = {
    0x00,0x04,0x09,0x08,0x15,0x0A,0x03,0x0A,0x07,0x0B,0x0A,0x03,0x05,0x07,0x00
};
...
{
    /* Put display into sleep and then assert reset
     * Use ST77xx-like commands: display off, sleep in
     */
    ct018_send_cmd(0x28); /* DISP OFF */
    Delay(50);
    ct018_send_cmd(0x10); /* SLP IN */
    Delay(120);
    GPIO_ResetBits(CT018_RST_GPIO_PORT, CT018_RST_PIN);
}
