...
registerParser(() => {
    ...
    const widthPresets = [32, 40, 42, 75, 120, 160, 192, 256, 320, 512];
    ...
    // Example calculations based on the binF.js map entries
    // Users can add their own by modifying this
    addCalculatorEntry(0, 0, 120, 160);      // Background
    addCalculatorEntry(0, 160, 40, 40);      // Battery Icon
    addCalculatorEntry(0, 200, 120, 32);     // Flame Animation
    addCalculatorEntry(0, 232, 42, 68);      // Unknown Background
