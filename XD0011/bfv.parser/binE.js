...
registerParser(() => {
    ...
    const map = [
        { idx:0,  offset:0x00000,  length:0xA000,  w:128,  h:160, category:'Background 1' },
        { idx:1,  offset:0x0A000,  length:0xA000,  w:128,  h:160,  category:'Background 2' },
        { idx:2,  offset:0x14000,  length:0x0708,  w:30,  h:30,  category:'Battery Icon' },
        { idx:3,  offset:0x14708,  length:0x0708,  w:30,  h:30,  category:'Battery Icon' },
